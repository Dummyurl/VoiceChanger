...
public abstract class SoundStreamRunnable implements Runnable {
    ...
    static final int DEFAULT_BYTES_PER_SAMPLE = 2;
    private static final long MAX_OUTPUT_BUFFER_SIZE = 1024;

    private final Object pauseLock = new Object();
    final Object sinkLock = new Object();
    final Object decodeLock = new Object();

    volatile long bytesWritten;

    SoundTouch soundTouch;
    volatile AudioDecoder decoder;
    ...
    public SoundStreamRunnable(int id, String fileName, float tempo, float pitchSemi) throws IOException {
