...
public class MediaCodecAudioEncoder implements AudioEncoder {
    ...
    public MediaCodecAudioEncoder(int samplingRate, int channels) throws IOException {
    ...
    @Override
    public int writeChunk(byte[] input, int offsetInBytes, int sizeInBytes) throws IOException {
        int total = 0;
